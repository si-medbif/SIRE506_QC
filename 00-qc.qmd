...
To calculate the SNP call rate, see this "Basic Statistics" page from PLINK2 document.

For missing i.e. 1 - (call rate), this could be calculated at the individual level or as a SNP position level.
